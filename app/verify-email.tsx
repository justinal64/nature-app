...
export default function VerifyEmailScreen() {
  ...
  return (
    <View className="flex-1 bg-background p-6 items-center justify-center">
      <Ionicons name="mail-unread-outline" size={80} color={COLORS.secondary} style={{ marginBottom: 24 }} />

      <Text className="text-[28px] font-bold text-text mb-4 text-center">Check Your Inbox</Text>
      <Text className="text-base text-textDim text-center mb-2">We sent a verification link to:</Text>
